...
func (d *TestResourceDie) DieFeedDuck(v any) *TestResourceDie {
...
func (d *TestResourceDie) DieReleaseDuck(v any) any {
...
func (d *TestResourceDie) UnmarshalJSON(b []byte) error {
	...
	resource := &resources.TestResource{}
...
type TestResourceSpecDie struct {
	...
	seal    resources.TestResourceSpec
}
...
// DieFeedDuck returns a new die with the provided value converted into the underlying type. Panics on error.
func (d *TestResourceSpecDie) DieFeedDuck(v any) *TestResourceSpecDie {
	data, err := json.Marshal(v)
	if err != nil {
		panic(err)
	}
...
// DieReleaseDuck releases the value into the passed value and returns the same. Panics on error.
func (d *TestResourceSpecDie) DieReleaseDuck(v any) any {
	data := d.DieReleaseJSON()
	if err := json.Unmarshal(data, v); err != nil {
		panic(err)
	}
...
type TestResourceStatusDie struct {
	...
	seal    resources.TestResourceStatus
}
...
// DieFeedDuck returns a new die with the provided value converted into the underlying type. Panics on error.
func (d *TestResourceStatusDie) DieFeedDuck(v any) *TestResourceStatusDie {
	data, err := json.Marshal(v)
	if err != nil {
		panic(err)
	}
...
// DieReleaseDuck releases the value into the passed value and returns the same. Panics on error.
func (d *TestResourceStatusDie) DieReleaseDuck(v any) any {
	data := d.DieReleaseJSON()
	if err := json.Unmarshal(data, v); err != nil {
		panic(err)
	}
...
type TestResourceEmptyStatusDie struct {
	...
	seal    resources.TestResourceEmptyStatus
}
...
// DieFeedDuck returns a new die with the provided value converted into the underlying type. Panics on error.
func (d *TestResourceEmptyStatusDie) DieFeedDuck(v any) *TestResourceEmptyStatusDie {
	data, err := json.Marshal(v)
	if err != nil {
		panic(err)
	}
...
// DieReleaseDuck releases the value into the passed value and returns the same. Panics on error.
func (d *TestResourceEmptyStatusDie) DieReleaseDuck(v any) any {
	data := d.DieReleaseJSON()
	if err := json.Unmarshal(data, v); err != nil {
		panic(err)
	}
...
func (d *TestResourceEmptyStatusDie) UnmarshalJSON(b []byte) error {
	...
	resource := &resources.TestResourceEmptyStatus{}
	err := json.Unmarshal(b, resource)
	*d = *d.DieFeed(*resource)
	return err
}
...
type TestResourceEmptyStatusStatusDie struct {
	...
	seal    resources.TestResourceEmptyStatusStatus
}
...
// DieFeedDuck returns a new die with the provided value converted into the underlying type. Panics on error.
func (d *TestResourceEmptyStatusStatusDie) DieFeedDuck(v any) *TestResourceEmptyStatusStatusDie {
	data, err := json.Marshal(v)
	if err != nil {
		panic(err)
	}
...
// DieReleaseDuck releases the value into the passed value and returns the same. Panics on error.
func (d *TestResourceEmptyStatusStatusDie) DieReleaseDuck(v any) any {
	data := d.DieReleaseJSON()
	if err := json.Unmarshal(data, v); err != nil {
		panic(err)
	}
...
type TestResourceNoStatusDie struct {
	...
	seal    resources.TestResourceNoStatus
}
...
// DieFeedDuck returns a new die with the provided value converted into the underlying type. Panics on error.
func (d *TestResourceNoStatusDie) DieFeedDuck(v any) *TestResourceNoStatusDie {
	data, err := json.Marshal(v)
	if err != nil {
		panic(err)
	}
...
// DieReleaseDuck releases the value into the passed value and returns the same. Panics on error.
func (d *TestResourceNoStatusDie) DieReleaseDuck(v any) any {
	data := d.DieReleaseJSON()
	if err := json.Unmarshal(data, v); err != nil {
		panic(err)
	}
...
func (d *TestResourceNoStatusDie) UnmarshalJSON(b []byte) error {
	...
	resource := &resources.TestResourceNoStatus{}
	err := json.Unmarshal(b, resource)
	*d = *d.DieFeed(*resource)
	return err
}
...
type TestResourceNilableStatusDie struct {
	...
	seal    resources.TestResourceNilableStatus
}
...
// DieFeedDuck returns a new die with the provided value converted into the underlying type. Panics on error.
func (d *TestResourceNilableStatusDie) DieFeedDuck(v any) *TestResourceNilableStatusDie {
	data, err := json.Marshal(v)
	if err != nil {
		panic(err)
	}
...
// DieReleaseDuck releases the value into the passed value and returns the same. Panics on error.
func (d *TestResourceNilableStatusDie) DieReleaseDuck(v any) any {
	data := d.DieReleaseJSON()
	if err := json.Unmarshal(data, v); err != nil {
		panic(err)
	}
...
func (d *TestResourceNilableStatusDie) UnmarshalJSON(b []byte) error {
	...
	resource := &resources.TestResourceNilableStatus{}
	err := json.Unmarshal(b, resource)
	*d = *d.DieFeed(*resource)
	return err
}
...
// DieFeedDuck returns a new die with the provided value converted into the underlying type. Panics on error.
func (d *TestDuckDie) DieFeedDuck(v any) *TestDuckDie {
	data, err := json.Marshal(v)
	if err != nil {
		panic(err)
	}
...
// DieReleaseDuck releases the value into the passed value and returns the same. Panics on error.
func (d *TestDuckDie) DieReleaseDuck(v any) any {
	data := d.DieReleaseJSON()
	if err := json.Unmarshal(data, v); err != nil {
		panic(err)
	}
...
// DieFeedDuck returns a new die with the provided value converted into the underlying type. Panics on error.
func (d *TestDuckSpecDie) DieFeedDuck(v any) *TestDuckSpecDie {
	data, err := json.Marshal(v)
	if err != nil {
		panic(err)
	}
...
// DieReleaseDuck releases the value into the passed value and returns the same. Panics on error.
func (d *TestDuckSpecDie) DieReleaseDuck(v any) any {
	data := d.DieReleaseJSON()
	if err := json.Unmarshal(data, v); err != nil {
		panic(err)
	}
...
type TestResourceUnexportedFieldsDie struct {
	...
	seal    resources.TestResourceUnexportedFields
}
...
// DieFeedDuck returns a new die with the provided value converted into the underlying type. Panics on error.
func (d *TestResourceUnexportedFieldsDie) DieFeedDuck(v any) *TestResourceUnexportedFieldsDie {
	data, err := json.Marshal(v)
	if err != nil {
		panic(err)
	}
...
// DieReleaseDuck releases the value into the passed value and returns the same. Panics on error.
func (d *TestResourceUnexportedFieldsDie) DieReleaseDuck(v any) any {
	data := d.DieReleaseJSON()
	if err := json.Unmarshal(data, v); err != nil {
		panic(err)
	}
...
func (d *TestResourceUnexportedFieldsDie) UnmarshalJSON(b []byte) error {
	...
	resource := &resources.TestResourceUnexportedFields{}
	err := json.Unmarshal(b, resource)
	*d = *d.DieFeed(*resource)
	return err
}
...
type TestResourceUnexportedFieldsSpecDie struct {
	...
	seal    resources.TestResourceUnexportedFieldsSpec
}
...
// DieFeedDuck returns a new die with the provided value converted into the underlying type. Panics on error.
func (d *TestResourceUnexportedFieldsSpecDie) DieFeedDuck(v any) *TestResourceUnexportedFieldsSpecDie {
	data, err := json.Marshal(v)
	if err != nil {
		panic(err)
	}
...
// DieReleaseDuck releases the value into the passed value and returns the same. Panics on error.
func (d *TestResourceUnexportedFieldsSpecDie) DieReleaseDuck(v any) any {
	data := d.DieReleaseJSON()
	if err := json.Unmarshal(data, v); err != nil {
		panic(err)
	}
...
type TestResourceUnexportedFieldsStatusDie struct {
	...
	seal    resources.TestResourceUnexportedFieldsStatus
}
...
// DieFeedDuck returns a new die with the provided value converted into the underlying type. Panics on error.
func (d *TestResourceUnexportedFieldsStatusDie) DieFeedDuck(v any) *TestResourceUnexportedFieldsStatusDie {
	data, err := json.Marshal(v)
	if err != nil {
		panic(err)
	}
...
// DieReleaseDuck releases the value into the passed value and returns the same. Panics on error.
func (d *TestResourceUnexportedFieldsStatusDie) DieReleaseDuck(v any) any {
	data := d.DieReleaseJSON()
	if err := json.Unmarshal(data, v); err != nil {
		panic(err)
	}
...
type TestResourceWithLegacyDefaultDie struct {
	v1.FrozenObjectMeta
	mutable bool
	r       resources.TestResourceWithLegacyDefault
	seal    resources.TestResourceWithLegacyDefault
}

// DieImmutable returns a new die for the current die's state that is either mutable (`false`) or immutable (`true`).
func (d *TestResourceWithLegacyDefaultDie) DieImmutable(immutable bool) *TestResourceWithLegacyDefaultDie {
	if d.mutable == !immutable {
		return d
	}
	d = d.DeepCopy()
...
// DieFeed returns a new die with the provided resource.
func (d *TestResourceWithLegacyDefaultDie) DieFeed(r resources.TestResourceWithLegacyDefault) *TestResourceWithLegacyDefaultDie {
	if d.mutable {
		d.FrozenObjectMeta = v1.FreezeObjectMeta(r.ObjectMeta)
		d.r = r
		return d
	}
	return &TestResourceWithLegacyDefaultDie{
		FrozenObjectMeta: v1.FreezeObjectMeta(r.ObjectMeta),
		mutable:          d.mutable,
		r:                r,
		seal:             d.seal,
...
// DieFeedPtr returns a new die with the provided resource pointer. If the resource is nil, the empty value is used instead.
func (d *TestResourceWithLegacyDefaultDie) DieFeedPtr(r *resources.TestResourceWithLegacyDefault) *TestResourceWithLegacyDefaultDie {
	if r == nil {
		r = &resources.TestResourceWithLegacyDefault{}
	}
	return d.DieFeed(*r)
...
// DieFeedDuck returns a new die with the provided value converted into the underlying type. Panics on error.
func (d *TestResourceWithLegacyDefaultDie) DieFeedDuck(v any) *TestResourceWithLegacyDefaultDie {
	data, err := json.Marshal(v)
	if err != nil {
		panic(err)
	}
...
// DieFeedJSON returns a new die with the provided JSON. Panics on error.
func (d *TestResourceWithLegacyDefaultDie) DieFeedJSON(j []byte) *TestResourceWithLegacyDefaultDie {
	r := resources.TestResourceWithLegacyDefault{}
	if err := json.Unmarshal(j, &r); err != nil {
		panic(err)
	}
...
// DieFeedYAML returns a new die with the provided YAML. Panics on error.
func (d *TestResourceWithLegacyDefaultDie) DieFeedYAML(y []byte) *TestResourceWithLegacyDefaultDie {
	r := resources.TestResourceWithLegacyDefault{}
	if err := yaml.Unmarshal(y, &r); err != nil {
		panic(err)
	}
...
// DieFeedYAMLFile returns a new die loading YAML from a file path. Panics on error.
func (d *TestResourceWithLegacyDefaultDie) DieFeedYAMLFile(name string) *TestResourceWithLegacyDefaultDie {
	y, err := osx.ReadFile(name)
	if err != nil {
		panic(err)
	}
...
// DieFeedRawExtension returns the resource managed by the die as an raw extension. Panics on error.
func (d *TestResourceWithLegacyDefaultDie) DieFeedRawExtension(raw runtime.RawExtension) *TestResourceWithLegacyDefaultDie {
	j, err := json.Marshal(raw)
	if err != nil {
		panic(err)
	}
...
// DieRelease returns the resource managed by the die.
func (d *TestResourceWithLegacyDefaultDie) DieRelease() resources.TestResourceWithLegacyDefault {
	if d.mutable {
		return d.r
	}
	return *d.r.DeepCopy()
...
// DieReleasePtr returns a pointer to the resource managed by the die.
func (d *TestResourceWithLegacyDefaultDie) DieReleasePtr() *resources.TestResourceWithLegacyDefault {
	r := d.DieRelease()
	return &r
}

// DieReleaseUnstructured returns the resource managed by the die as an unstructured object. Panics on error.
func (d *TestResourceWithLegacyDefaultDie) DieReleaseUnstructured() *unstructured.Unstructured {
	r := d.DieReleasePtr()
	u, err := runtime.DefaultUnstructuredConverter.ToUnstructured(r)
	if err != nil {
		panic(err)
...
// DieReleaseDuck releases the value into the passed value and returns the same. Panics on error.
func (d *TestResourceWithLegacyDefaultDie) DieReleaseDuck(v any) any {
	data := d.DieReleaseJSON()
	if err := json.Unmarshal(data, v); err != nil {
		panic(err)
	}
...
// DieReleaseJSON returns the resource managed by the die as JSON. Panics on error.
func (d *TestResourceWithLegacyDefaultDie) DieReleaseJSON() []byte {
	r := d.DieReleasePtr()
	j, err := json.Marshal(r)
	if err != nil {
		panic(err)
...
// DieReleaseYAML returns the resource managed by the die as YAML. Panics on error.
func (d *TestResourceWithLegacyDefaultDie) DieReleaseYAML() []byte {
	r := d.DieReleasePtr()
	y, err := yaml.Marshal(r)
	if err != nil {
		panic(err)
...
// DieReleaseRawExtension returns the resource managed by the die as an raw extension. Panics on error.
func (d *TestResourceWithLegacyDefaultDie) DieReleaseRawExtension() runtime.RawExtension {
	j := d.DieReleaseJSON()
	raw := runtime.RawExtension{}
	if err := json.Unmarshal(j, &raw); err != nil {
		panic(err)
...
// DieStamp returns a new die with the resource passed to the callback function. The resource is mutable.
func (d *TestResourceWithLegacyDefaultDie) DieStamp(fn func(r *resources.TestResourceWithLegacyDefault)) *TestResourceWithLegacyDefaultDie {
	r := d.DieRelease()
	fn(&r)
	return d.DieFeed(r)
}
...
//
// Future iterations will improve type coercion from the resource to the callback argument.
func (d *TestResourceWithLegacyDefaultDie) DieStampAt(jp string, fn interface{}) *TestResourceWithLegacyDefaultDie {
	return d.DieStamp(func(r *resources.TestResourceWithLegacyDefault) {
		if ni := reflectx.ValueOf(fn).Type().NumIn(); ni != 1 {
			panic(fmtx.Errorf("callback function must have 1 input parameters, found %d", ni))
		}
		if no := reflectx.ValueOf(fn).Type().NumOut(); no != 0 {
...
// DieWith returns a new die after passing the current die to the callback function. The passed die is mutable.
func (d *TestResourceWithLegacyDefaultDie) DieWith(fns ...func(d *TestResourceWithLegacyDefaultDie)) *TestResourceWithLegacyDefaultDie {
	nd := TestResourceWithLegacyDefaultBlank.DieFeed(d.DieRelease()).DieImmutable(false)
	for _, fn := range fns {
		if fn != nil {
			fn(nd)
		}
...
// DeepCopy returns a new die with equivalent state. Useful for snapshotting a mutable die.
func (d *TestResourceWithLegacyDefaultDie) DeepCopy() *TestResourceWithLegacyDefaultDie {
	r := *d.r.DeepCopy()
	return &TestResourceWithLegacyDefaultDie{
		FrozenObjectMeta: v1.FreezeObjectMeta(r.ObjectMeta),
		mutable:          d.mutable,
...
// DieSeal returns a new die for the current die's state that is sealed for comparison in future diff and patch operations.
func (d *TestResourceWithLegacyDefaultDie) DieSeal() *TestResourceWithLegacyDefaultDie {
	return d.DieSealFeed(d.r)
}

// DieSealFeed returns a new die for the current die's state that uses a specific resource for comparison in future diff and patch operations.
func (d *TestResourceWithLegacyDefaultDie) DieSealFeed(r resources.TestResourceWithLegacyDefault) *TestResourceWithLegacyDefaultDie {
	if !d.mutable {
		d = d.DeepCopy()
	}
	d.seal = *r.DeepCopy()
...
// DieSealFeedPtr returns a new die for the current die's state that uses a specific resource pointer for comparison in future diff and patch operations. If the resource is nil, the empty value is used instead.
func (d *TestResourceWithLegacyDefaultDie) DieSealFeedPtr(r *resources.TestResourceWithLegacyDefault) *TestResourceWithLegacyDefaultDie {
	if r == nil {
		r = &resources.TestResourceWithLegacyDefault{}
	}
	return d.DieSealFeed(*r)
...
// DieSealRelease returns the sealed resource managed by the die.
func (d *TestResourceWithLegacyDefaultDie) DieSealRelease() resources.TestResourceWithLegacyDefault {
	return *d.seal.DeepCopy()
}

// DieSealReleasePtr returns the sealed resource pointer managed by the die.
func (d *TestResourceWithLegacyDefaultDie) DieSealReleasePtr() *resources.TestResourceWithLegacyDefault {
	r := d.DieSealRelease()
	return &r
}

// DieDiff uses cmp.Diff to compare the current value of the die with the sealed value.
func (d *TestResourceWithLegacyDefaultDie) DieDiff(opts ...cmp.Option) string {
	return cmp.Diff(d.seal, d.r, opts...)
}

// DiePatch generates a patch between the current value of the die and the sealed value.
func (d *TestResourceWithLegacyDefaultDie) DiePatch(patchType types.PatchType) ([]byte, error) {
	return patch.Create(d.seal, d.r, patchType)
}

var _ runtime.Object = (*TestResourceWithLegacyDefaultDie)(nil)

func (d *TestResourceWithLegacyDefaultDie) DeepCopyObject() runtime.Object {
	return d.r.DeepCopy()
}

func (d *TestResourceWithLegacyDefaultDie) GetObjectKind() schema.ObjectKind {
	r := d.DieRelease()
	return r.GetObjectKind()
}

func (d *TestResourceWithLegacyDefaultDie) MarshalJSON() ([]byte, error) {
	return json.Marshal(d.r)
}

func (d *TestResourceWithLegacyDefaultDie) UnmarshalJSON(b []byte) error {
	if !d.mutable {
		return fmtx.Errorf("cannot unmarshal into immutable dies, create a mutable version first")
	}
	resource := &resources.TestResourceWithLegacyDefault{}
	err := json.Unmarshal(b, resource)
	*d = *d.DieFeed(*resource)
	return err
}
...
// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
func (d *TestResourceWithLegacyDefaultDie) APIVersion(v string) *TestResourceWithLegacyDefaultDie {
	return d.DieStamp(func(r *resources.TestResourceWithLegacyDefault) {
		r.APIVersion = v
	})
}
...
// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
func (d *TestResourceWithLegacyDefaultDie) Kind(v string) *TestResourceWithLegacyDefaultDie {
	return d.DieStamp(func(r *resources.TestResourceWithLegacyDefault) {
		r.Kind = v
	})
}
...
// TypeMetadata standard object's type metadata.
func (d *TestResourceWithLegacyDefaultDie) TypeMetadata(v metav1.TypeMeta) *TestResourceWithLegacyDefaultDie {
	return d.DieStamp(func(r *resources.TestResourceWithLegacyDefault) {
		r.TypeMeta = v
	})
}
...
// TypeMetadataDie stamps the resource's TypeMeta field with a mutable die.
func (d *TestResourceWithLegacyDefaultDie) TypeMetadataDie(fn func(d *v1.TypeMetaDie)) *TestResourceWithLegacyDefaultDie {
	return d.DieStamp(func(r *resources.TestResourceWithLegacyDefault) {
		d := v1.TypeMetaBlank.DieImmutable(false).DieFeed(r.TypeMeta)
		fn(d)
		r.TypeMeta = d.DieRelease()
...
// Metadata standard object's metadata.
func (d *TestResourceWithLegacyDefaultDie) Metadata(v metav1.ObjectMeta) *TestResourceWithLegacyDefaultDie {
	return d.DieStamp(func(r *resources.TestResourceWithLegacyDefault) {
		r.ObjectMeta = v
	})
}
...
// MetadataDie stamps the resource's ObjectMeta field with a mutable die.
func (d *TestResourceWithLegacyDefaultDie) MetadataDie(fn func(d *v1.ObjectMetaDie)) *TestResourceWithLegacyDefaultDie {
	return d.DieStamp(func(r *resources.TestResourceWithLegacyDefault) {
		d := v1.ObjectMetaBlank.DieImmutable(false).DieFeed(r.ObjectMeta)
		fn(d)
		r.ObjectMeta = d.DieRelease()
...
// SpecDie stamps the resource's spec field with a mutable die.
func (d *TestResourceWithLegacyDefaultDie) SpecDie(fn func(d *TestResourceSpecDie)) *TestResourceWithLegacyDefaultDie {
	return d.DieStamp(func(r *resources.TestResourceWithLegacyDefault) {
		d := TestResourceSpecBlank.DieImmutable(false).DieFeed(r.Spec)
		fn(d)
		r.Spec = d.DieRelease()
...
// StatusDie stamps the resource's status field with a mutable die.
func (d *TestResourceWithLegacyDefaultDie) StatusDie(fn func(d *TestResourceStatusDie)) *TestResourceWithLegacyDefaultDie {
	return d.DieStamp(func(r *resources.TestResourceWithLegacyDefault) {
		d := TestResourceStatusBlank.DieImmutable(false).DieFeed(r.Status)
		fn(d)
		r.Status = d.DieRelease()
...
func (d *TestResourceWithLegacyDefaultDie) Spec(v resources.TestResourceSpec) *TestResourceWithLegacyDefaultDie {
	return d.DieStamp(func(r *resources.TestResourceWithLegacyDefault) {
		r.Spec = v
	})
}

func (d *TestResourceWithLegacyDefaultDie) Status(v resources.TestResourceStatus) *TestResourceWithLegacyDefaultDie {
	return d.DieStamp(func(r *resources.TestResourceWithLegacyDefault) {
		r.Status = v
	})
}

var TestResourceWithObjectDefaultBlank = (&TestResourceWithObjectDefaultDie{}).DieFeed(resources.TestResourceWithObjectDefault{})

type TestResourceWithObjectDefaultDie struct {
	v1.FrozenObjectMeta
	mutable bool
	r       resources.TestResourceWithObjectDefault
	seal    resources.TestResourceWithObjectDefault
}

// DieImmutable returns a new die for the current die's state that is either mutable (`false`) or immutable (`true`).
func (d *TestResourceWithObjectDefaultDie) DieImmutable(immutable bool) *TestResourceWithObjectDefaultDie {
	if d.mutable == !immutable {
		return d
	}
	d = d.DeepCopy()
...
// DieFeed returns a new die with the provided resource.
func (d *TestResourceWithObjectDefaultDie) DieFeed(r resources.TestResourceWithObjectDefault) *TestResourceWithObjectDefaultDie {
	if d.mutable {
		d.FrozenObjectMeta = v1.FreezeObjectMeta(r.ObjectMeta)
		d.r = r
		return d
	}
	return &TestResourceWithObjectDefaultDie{
		FrozenObjectMeta: v1.FreezeObjectMeta(r.ObjectMeta),
		mutable:          d.mutable,
		r:                r,
		seal:             d.seal,
...
// DieFeedPtr returns a new die with the provided resource pointer. If the resource is nil, the empty value is used instead.
func (d *TestResourceWithObjectDefaultDie) DieFeedPtr(r *resources.TestResourceWithObjectDefault) *TestResourceWithObjectDefaultDie {
	if r == nil {
		r = &resources.TestResourceWithObjectDefault{}
	}
	return d.DieFeed(*r)
...
// DieFeedDuck returns a new die with the provided value converted into the underlying type. Panics on error.
func (d *TestResourceWithObjectDefaultDie) DieFeedDuck(v any) *TestResourceWithObjectDefaultDie {
	data, err := json.Marshal(v)
	if err != nil {
		panic(err)
	}
...
// DieFeedJSON returns a new die with the provided JSON. Panics on error.
func (d *TestResourceWithObjectDefaultDie) DieFeedJSON(j []byte) *TestResourceWithObjectDefaultDie {
	r := resources.TestResourceWithObjectDefault{}
	if err := json.Unmarshal(j, &r); err != nil {
		panic(err)
	}
...
// DieFeedYAML returns a new die with the provided YAML. Panics on error.
func (d *TestResourceWithObjectDefaultDie) DieFeedYAML(y []byte) *TestResourceWithObjectDefaultDie {
	r := resources.TestResourceWithObjectDefault{}
	if err := yaml.Unmarshal(y, &r); err != nil {
		panic(err)
	}
...
// DieFeedYAMLFile returns a new die loading YAML from a file path. Panics on error.
func (d *TestResourceWithObjectDefaultDie) DieFeedYAMLFile(name string) *TestResourceWithObjectDefaultDie {
	y, err := osx.ReadFile(name)
	if err != nil {
		panic(err)
	}
...
// DieFeedRawExtension returns the resource managed by the die as an raw extension. Panics on error.
func (d *TestResourceWithObjectDefaultDie) DieFeedRawExtension(raw runtime.RawExtension) *TestResourceWithObjectDefaultDie {
	j, err := json.Marshal(raw)
	if err != nil {
		panic(err)
	}
...
// DieRelease returns the resource managed by the die.
func (d *TestResourceWithObjectDefaultDie) DieRelease() resources.TestResourceWithObjectDefault {
	if d.mutable {
		return d.r
	}
	return *d.r.DeepCopy()
...
// DieReleasePtr returns a pointer to the resource managed by the die.
func (d *TestResourceWithObjectDefaultDie) DieReleasePtr() *resources.TestResourceWithObjectDefault {
	r := d.DieRelease()
	return &r
}

// DieReleaseUnstructured returns the resource managed by the die as an unstructured object. Panics on error.
func (d *TestResourceWithObjectDefaultDie) DieReleaseUnstructured() *unstructured.Unstructured {
	r := d.DieReleasePtr()
	u, err := runtime.DefaultUnstructuredConverter.ToUnstructured(r)
	if err != nil {
		panic(err)
...
// DieReleaseDuck releases the value into the passed value and returns the same. Panics on error.
func (d *TestResourceWithObjectDefaultDie) DieReleaseDuck(v any) any {
	data := d.DieReleaseJSON()
	if err := json.Unmarshal(data, v); err != nil {
		panic(err)
	}
...
// DieReleaseJSON returns the resource managed by the die as JSON. Panics on error.
func (d *TestResourceWithObjectDefaultDie) DieReleaseJSON() []byte {
	r := d.DieReleasePtr()
	j, err := json.Marshal(r)
	if err != nil {
		panic(err)
...
// DieReleaseYAML returns the resource managed by the die as YAML. Panics on error.
func (d *TestResourceWithObjectDefaultDie) DieReleaseYAML() []byte {
	r := d.DieReleasePtr()
	y, err := yaml.Marshal(r)
	if err != nil {
		panic(err)
...
// DieReleaseRawExtension returns the resource managed by the die as an raw extension. Panics on error.
func (d *TestResourceWithObjectDefaultDie) DieReleaseRawExtension() runtime.RawExtension {
	j := d.DieReleaseJSON()
	raw := runtime.RawExtension{}
	if err := json.Unmarshal(j, &raw); err != nil {
		panic(err)
...
// DieStamp returns a new die with the resource passed to the callback function. The resource is mutable.
func (d *TestResourceWithObjectDefaultDie) DieStamp(fn func(r *resources.TestResourceWithObjectDefault)) *TestResourceWithObjectDefaultDie {
	r := d.DieRelease()
	fn(&r)
	return d.DieFeed(r)
}
...
//
// Future iterations will improve type coercion from the resource to the callback argument.
func (d *TestResourceWithObjectDefaultDie) DieStampAt(jp string, fn interface{}) *TestResourceWithObjectDefaultDie {
	return d.DieStamp(func(r *resources.TestResourceWithObjectDefault) {
		if ni := reflectx.ValueOf(fn).Type().NumIn(); ni != 1 {
			panic(fmtx.Errorf("callback function must have 1 input parameters, found %d", ni))
		}
		if no := reflectx.ValueOf(fn).Type().NumOut(); no != 0 {
...
// DieWith returns a new die after passing the current die to the callback function. The passed die is mutable.
func (d *TestResourceWithObjectDefaultDie) DieWith(fns ...func(d *TestResourceWithObjectDefaultDie)) *TestResourceWithObjectDefaultDie {
	nd := TestResourceWithObjectDefaultBlank.DieFeed(d.DieRelease()).DieImmutable(false)
	for _, fn := range fns {
		if fn != nil {
			fn(nd)
		}
...
// DeepCopy returns a new die with equivalent state. Useful for snapshotting a mutable die.
func (d *TestResourceWithObjectDefaultDie) DeepCopy() *TestResourceWithObjectDefaultDie {
	r := *d.r.DeepCopy()
	return &TestResourceWithObjectDefaultDie{
		FrozenObjectMeta: v1.FreezeObjectMeta(r.ObjectMeta),
		mutable:          d.mutable,
...
// DieSeal returns a new die for the current die's state that is sealed for comparison in future diff and patch operations.
func (d *TestResourceWithObjectDefaultDie) DieSeal() *TestResourceWithObjectDefaultDie {
	return d.DieSealFeed(d.r)
}

// DieSealFeed returns a new die for the current die's state that uses a specific resource for comparison in future diff and patch operations.
func (d *TestResourceWithObjectDefaultDie) DieSealFeed(r resources.TestResourceWithObjectDefault) *TestResourceWithObjectDefaultDie {
	if !d.mutable {
		d = d.DeepCopy()
	}
	d.seal = *r.DeepCopy()
...
// DieSealFeedPtr returns a new die for the current die's state that uses a specific resource pointer for comparison in future diff and patch operations. If the resource is nil, the empty value is used instead.
func (d *TestResourceWithObjectDefaultDie) DieSealFeedPtr(r *resources.TestResourceWithObjectDefault) *TestResourceWithObjectDefaultDie {
	if r == nil {
		r = &resources.TestResourceWithObjectDefault{}
	}
	return d.DieSealFeed(*r)
...
// DieSealRelease returns the sealed resource managed by the die.
func (d *TestResourceWithObjectDefaultDie) DieSealRelease() resources.TestResourceWithObjectDefault {
	return *d.seal.DeepCopy()
}

// DieSealReleasePtr returns the sealed resource pointer managed by the die.
func (d *TestResourceWithObjectDefaultDie) DieSealReleasePtr() *resources.TestResourceWithObjectDefault {
	r := d.DieSealRelease()
	return &r
}

// DieDiff uses cmp.Diff to compare the current value of the die with the sealed value.
func (d *TestResourceWithObjectDefaultDie) DieDiff(opts ...cmp.Option) string {
	return cmp.Diff(d.seal, d.r, opts...)
}

// DiePatch generates a patch between the current value of the die and the sealed value.
func (d *TestResourceWithObjectDefaultDie) DiePatch(patchType types.PatchType) ([]byte, error) {
	return patch.Create(d.seal, d.r, patchType)
}

var _ runtime.Object = (*TestResourceWithObjectDefaultDie)(nil)

func (d *TestResourceWithObjectDefaultDie) DeepCopyObject() runtime.Object {
	return d.r.DeepCopy()
}

func (d *TestResourceWithObjectDefaultDie) GetObjectKind() schema.ObjectKind {
	r := d.DieRelease()
	return r.GetObjectKind()
}

func (d *TestResourceWithObjectDefaultDie) MarshalJSON() ([]byte, error) {
	return json.Marshal(d.r)
}

func (d *TestResourceWithObjectDefaultDie) UnmarshalJSON(b []byte) error {
	if !d.mutable {
		return fmtx.Errorf("cannot unmarshal into immutable dies, create a mutable version first")
	}
	resource := &resources.TestResourceWithObjectDefault{}
	err := json.Unmarshal(b, resource)
	*d = *d.DieFeed(*resource)
	return err
}
...
// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
func (d *TestResourceWithObjectDefaultDie) APIVersion(v string) *TestResourceWithObjectDefaultDie {
	return d.DieStamp(func(r *resources.TestResourceWithObjectDefault) {
		r.APIVersion = v
	})
}
...
// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
func (d *TestResourceWithObjectDefaultDie) Kind(v string) *TestResourceWithObjectDefaultDie {
	return d.DieStamp(func(r *resources.TestResourceWithObjectDefault) {
		r.Kind = v
	})
}
...
// TypeMetadata standard object's type metadata.
func (d *TestResourceWithObjectDefaultDie) TypeMetadata(v metav1.TypeMeta) *TestResourceWithObjectDefaultDie {
	return d.DieStamp(func(r *resources.TestResourceWithObjectDefault) {
		r.TypeMeta = v
	})
}
...
// TypeMetadataDie stamps the resource's TypeMeta field with a mutable die.
func (d *TestResourceWithObjectDefaultDie) TypeMetadataDie(fn func(d *v1.TypeMetaDie)) *TestResourceWithObjectDefaultDie {
	return d.DieStamp(func(r *resources.TestResourceWithObjectDefault) {
		d := v1.TypeMetaBlank.DieImmutable(false).DieFeed(r.TypeMeta)
		fn(d)
		r.TypeMeta = d.DieRelease()
...
// Metadata standard object's metadata.
func (d *TestResourceWithObjectDefaultDie) Metadata(v metav1.ObjectMeta) *TestResourceWithObjectDefaultDie {
	return d.DieStamp(func(r *resources.TestResourceWithObjectDefault) {
		r.ObjectMeta = v
	})
}
...
// MetadataDie stamps the resource's ObjectMeta field with a mutable die.
func (d *TestResourceWithObjectDefaultDie) MetadataDie(fn func(d *v1.ObjectMetaDie)) *TestResourceWithObjectDefaultDie {
	return d.DieStamp(func(r *resources.TestResourceWithObjectDefault) {
		d := v1.ObjectMetaBlank.DieImmutable(false).DieFeed(r.ObjectMeta)
		fn(d)
		r.ObjectMeta = d.DieRelease()
...
// SpecDie stamps the resource's spec field with a mutable die.
func (d *TestResourceWithObjectDefaultDie) SpecDie(fn func(d *TestResourceSpecDie)) *TestResourceWithObjectDefaultDie {
	return d.DieStamp(func(r *resources.TestResourceWithObjectDefault) {
		d := TestResourceSpecBlank.DieImmutable(false).DieFeed(r.Spec)
		fn(d)
		r.Spec = d.DieRelease()
...
// StatusDie stamps the resource's status field with a mutable die.
func (d *TestResourceWithObjectDefaultDie) StatusDie(fn func(d *TestResourceStatusDie)) *TestResourceWithObjectDefaultDie {
	return d.DieStamp(func(r *resources.TestResourceWithObjectDefault) {
		d := TestResourceStatusBlank.DieImmutable(false).DieFeed(r.Status)
		fn(d)
		r.Status = d.DieRelease()
...
func (d *TestResourceWithObjectDefaultDie) Spec(v resources.TestResourceSpec) *TestResourceWithObjectDefaultDie {
	return d.DieStamp(func(r *resources.TestResourceWithObjectDefault) {
		r.Spec = v
	})
}

func (d *TestResourceWithObjectDefaultDie) Status(v resources.TestResourceStatus) *TestResourceWithObjectDefaultDie {
	return d.DieStamp(func(r *resources.TestResourceWithObjectDefault) {
		r.Status = v
	})
}
